...
// Ordem reflete a sidebar real do Layout.jsx (sem itens removidos)
export const TOUR_MODULES = [
  {
    route: 'Dashboard',
    title: 'Dashboard',
    icon: LayoutDashboard,
    description: 'Visão executiva consolidada com KPIs, tendências e alertas em tempo real sobre o território.',
    features: [
  ...
  },
  {
    ...
    title: 'Análise',
    icon: BarChart3,
    description: 'Central de análises: gráficos de tendências, comparativos e indicadores territoriais.',
    features: [
  ...
  },
  {
    ...
    title: 'Assistente IA',
    icon: Sparkles,
    description: 'Chat inteligente que responde perguntas sobre o sistema e analisa os dados reais cadastrados.',
    features: [
  ...
  },
  {
    ...
    features: [
      ...
      'Fontes oficiais brasileiras (IBGE, DATASUS, INEP, SICONFI, ANM, ANATEL, ANA)',
