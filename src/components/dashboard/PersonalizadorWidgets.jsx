...
const widgetsDisponiveis = [
  ...
  { id: 'temperatura_territorial', nome: 'Temperatura Territorial', descricao: 'Agregação de riscos e engajamento por comunidade' },
  { id: 'rede_stakeholders', nome: 'Rede de Stakeholders', descricao: 'Visualização de conexões entre stakeholders' },
  { id: 'stakeholders_riscos', nome: 'Stakeholders × Riscos', descricao: 'Integração entre engajamento e mitigação de riscos' },
