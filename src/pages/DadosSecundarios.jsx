...
const SECOES = [
  ...
  { id: 'economia', label: 'Economia e Trabalho', icon: Database, viaIA: true },
  { id: 'saude', label: 'Saúde', icon: Database, viaIA: true },
  { id: 'educacao', label: 'Educação', icon: Database, viaIA: true },
  { id: 'assistencia_vulnerabilidade', label: 'Assistência e Vulnerabilidade', icon: Database, viaIA: true },
  ...
  { id: 'politicas_publicas', label: 'Políticas Públicas', icon: Database, viaIA: true },
  { id: 'legislacao', label: 'Regulatório', icon: Database, viaIA: true },
  { id: 'saneamento', label: 'Saneamento', icon: Droplets, viaIA: true },
